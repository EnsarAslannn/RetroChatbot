...
Genel `upstream_error` yanıtı, tanı için yalnızca istisna türünü (`error_type`) ve varsa sayısal sağlayıcı kodunu (`provider_code`) içerir; sağlayıcının ham hata metni veya anahtar yanıtlanmaz.
